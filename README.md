...
## 2. images_sentry
Позволяет получать все картинки в директории, сортировать их по параметрам, переименовывать, сравнивать, искать дубли в директории, а также просматривать и редактировать (записывать тэги) exif.
